  ...
  <div className="bg-card-fill rounded-3xl px-6 sm:px-10 pt-6 flex flex-col my-2 bg-[#EBEBEB] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] border-table-border mt-8">
    <div className="flex flex-col mb-4">
      <div className="flex flex-col sm:flex-row items-center sm:justify-between mb-4">
        <label
          className="block tracking-wide text-nts-black text-[15px] font-[600] sm:mr-4 mb-2 sm:mb-0"
          htmlFor="profile"
        >
          Profile
        </label>
        <input
          className="appearance-none w-full sm:flex-1 bg-grey-lighter text-grey-darker border border-table-border rounded-xl py-3 px-4 shadow-[0px_4px_0px_0px_#00000025]"
          id="profile"
          placeholder="Profile"
          {...register("profile")}
        />
      ...
      <div className="flex flex-col sm:flex-row items-center sm:justify-between mb-4">
        ...
        <div className="flex items-center w-full sm:flex-1">
          ...
          <img
            src={add}
            className={`w-10 sm:w-12 h-10 sm:h-12 ml-4 cursor-pointer ${
    ...
    <div className="flex justify-center mt-8 sm:mt-16 mb-10">
      <button
        className="text-white bg-nts-green px-6 py-3 rounded-lg w-full sm:w-auto"
        type="submit"
      >
        Chercher
      </button>
