...
# Dictionnaire des compétences avec leurs synonymes
...
def select_resume(profile: str, key_skills: list) -> None:
        competence_trouvee = []
        ...
        search_string = ' '.join(extended_profiles)
        ...
        results = dumps(cvs.aggregate(pipeline))
        return results  ,  key_skills , search_string


results , key , extended_profiles= select_resume(profile,skills)
print(results , key , extended_profiles)


# def trouver_profil(term):
#     term = term.lower()
#     profils = []
#     for profil, synonymes in profil_synonymes.items():
#         if term in [syn.lower() for syn in synonymes]:
#             profils.append(profil)  # Append without reassigning profils
#     return profils

# # Exemple d'utilisation
# terme_recherche = "développeur web"
# profil_trouve = trouver_profil(terme_recherche)
# print(f"Le profil correspondant au terme '{terme_recherche}' est : {profil_trouve}")
